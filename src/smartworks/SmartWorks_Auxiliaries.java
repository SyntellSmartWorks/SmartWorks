	...
	
    {
      Assert.assertTrue(true);
        ...
        //==========================ADD METER========================================================//
            ...
            if(dr.findElements(By.xpath("//span[text() = 'Auxiliaries']")).size() > 0)
            {
                Thread.sleep(500);
            ...
            if(dr.findElements(By.xpath("//input[@id = 'txtAuxAccDetails_OpeningBal']")).size() > 0)
            {
                Thread.sleep(500);
            ...
            if(dr.findElements(By.xpath("//input[@id = 'txtAuxAccDetails_CollectPerc']")).size() > 0)
            {
                Thread.sleep(500);
            ...
            if(dr.findElements(By.xpath("//input[@id = 'btnAuxDetailsSave']")).size() > 0)
            {
                Thread.sleep(500);
