 ...
 * @author Reece
 */
public class SmartWorks_Agents
{
 public static WebDriver dr;
	...
	
    {
      Assert.assertTrue(true);
        ...
        //==========================ADD TARIFF========================================================//
            if(dr.findElements(By.xpath("//span[text() = 'Agents']")).size() > 0)
            {
                Thread.sleep(500);
                dr.findElement(By.xpath("//span[text() = 'Agents']")).click();
                test.log(LogStatus.PASS, "Successfully navigated to Meters");
            }
            else
            {
            ...
            if(dr.findElements(By.xpath("//span[text() = 'Manage Agent Accounts']")).size() > 0)
            {
                Thread.sleep(500);
                dr.findElement(By.xpath("//span[text() = 'Manage Agent Accounts']")).click();
                test.log(LogStatus.PASS, "Successfully navigated to Meters");
            }
            else
            {
            ...
            if(dr.findElements(By.xpath("//*[@id='ddlRegion_chosen']/a/div/b")).size() > 0)
            {
                ...
                dr.findElement(By.xpath("//li[text() = 'STELLENBOSCH']")).click();
                test.log(LogStatus.PASS, "Successfully navigated to Meters");
            }
            else
            {
            ...
            {
                Thread.sleep(500);
                dr.findElement(By.xpath("//input[@id= 'txtCustAccRef']")).sendKeys("ReeceTest02");
                test.log(LogStatus.PASS, "Successfully navigated to Meters");
            }
            else
            {
            ...
            if(dr.findElements(By.xpath("//label[contains(text(), 'Reece')]")).size() > 0)
            {
                Thread.sleep(500);
                dr.findElement(By.xpath("//button[text() = '0 associated']")).click();
                dr.findElement(By.xpath("//label[contains(text(), 'Reece')]")).click();
                dr.findElement(By.xpath("//label[contains(text(), 'Reece')]")).sendKeys(Keys.PAGE_UP);
                dr.findElement(By.xpath("//button[contains(text(), 'Reece')]")).click();
                test.log(LogStatus.PASS, "Successfully navigated to Meters");
            }
            else
            {
            ...
            if(dr.findElements(By.xpath("//label[text() = '  Select all']")).size() > 0)
            {
                Thread.sleep(500);
                dr.findElement(By.xpath("//button[text() = 'None selected ']")).click();
            ...
            if(dr.findElements(By.xpath("//input[@id = 'txtColAccLimit']")).size() > 0)
            {
                Thread.sleep(500);
                dr.findElement(By.xpath("//input[@id = 'txtColAccLimit']")).sendKeys("-50000");
                test.log(LogStatus.PASS, "Successfully navigated to Meters");
            }
            else
            {
